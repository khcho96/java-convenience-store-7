...
public class InputView {
    ...
    public static String readPromotionQuantityShortage(String itemName, int promotionQuantityShortage) {
        System.out.printf("현재 %s %d개는 프로모션 할인이 적용되지 않습니다. 그래도 구매하시겠습니까? (Y/N)", itemName, promotionQuantityShortage);
        return Console.readLine();
    }

    public static String readChanceOfFree(String itemName) {
        System.out.printf("현재 %s은(는) 1개를 무료로 더 받을 수 있습니다. 추가하시겠습니까? (Y/N)", itemName);
        return Console.readLine();
    }
}
